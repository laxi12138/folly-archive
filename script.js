...
'plague-scan': {
  ...
  'plague-film': {
    ...
    'north-hum': {
        title: '聲音標本',
        mode: 'audio',
        src: 'attachments/fallen-wing-field/hum.wav',
        desc: ''
    },
    ...
    'north-ticket': {
        title: '物件標本',
        mode: 'image',
        src: 'attachments/fallen-wing-field/ticket.jpg',
        desc: ''
    },
...
`;
    ...
    treeHTML = createRecordTree({
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-hall')">
 ...
 <div
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-corridor')">
