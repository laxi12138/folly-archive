...
'wave-01': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/wave-eroded-structure/35mm-scan-1.jpg',
  desc: ''
},
...
'wave-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/wave-eroded-structure/35mm-scan-2.jpg',
  desc: ''
},
'wave-03': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/wave-eroded-structure/35mm-scan-3.jpg',
  desc: ''
},
'wave-04': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/wave-eroded-structure/35mm-scan-4.jpg',
  desc: ''
},
...
'brick-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/brick-battleship/35mm-scan-1.jpg',
  desc: ''
},
'brick-03': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/brick-battleship/35mm-scan-2.jpg',
  desc: ''
},
'brick-audio': {
  title: '聲音標本',
...
'quarry-01': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/quarry-bay-stairway/photo-01.jpg',
  desc: ''
},
...
'quarry-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/quarry-bay-stairway/photo-02.jpg',
  desc: ''
},
...
'bath-01': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/bath-crack/photo-01.jpg',
  desc: ''
},
...
'bath-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/bath-crack/photo-02.jpg',
  desc: ''
},
...
'yellow-01': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/yellow-mountain/35mm-scan-1.jpg',
  desc: ''
},
...
'yellow-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/yellow-mountain/35mm-scan-2.jpg',
  desc: ''
},
...
'gloss-01': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/gloss-veil/35mm-scan-1.jpg',
  desc: ''
},
...
'gloss-02': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/gloss-veil/35mm-scan-2.jpg',
  desc: ''
},
'gloss-03': {
  title: '視覺標本',
  mode: 'image',
  src: 'attachments/gloss-veil/35mm-scan-3.jpg',
  desc: ''
},
...
`;
  ...
  treeHTML = createRecordTree({

    id: 'signal',

    folder: 'mountain-signal',
  ...
  treeHTML = createRecordTree({
    ...
    folder: 'wave-eroded-structure',

    visualFiles: `

      <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-01')">
 ...
 <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-02')">
 ...
 <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-03')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-04')">
    ...
    audioFiles: `
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-audio')">
    ...
    noteFiles: `
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('wave-note')">
  ...
  treeHTML = createRecordTree({
    ...
    folder: 'brick-battleship',

    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('brick-01')">
...
<div
        class="tree-file"
        onclick="openAttachmentViewer('brick-02')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('brick-03')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('brick-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('brick-note')">
  ...
  treeHTML = createRecordTree({
    ...
    folder: 'quarry-bay-stairway',

    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('quarry-01')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('quarry-02')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('quarry-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('quarry-note')">
  ...
  treeHTML = createRecordTree({
    ...
    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('bath-01')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('bath-02')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('bath-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('bath-note')">
  ...
  treeHTML = createRecordTree({
    ...
    folder: 'yellow-mountain',

    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('yellow-01')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('yellow-02')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('yellow-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('yellow-note')">
  ...
  treeHTML = createRecordTree({
    ...
    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-01')">
...
<div
        class="tree-file"
        onclick="openAttachmentViewer('fish-02')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-03')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-note')">
  ...
  treeHTML = createRecordTree({
    ...
    visualFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-01')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-02')">
       ...
       <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-03')">
    ...
    audioFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-audio')">
    ...
    noteFiles: `
      <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-note')">
...
const sites = [
    ...
    {
  name: "波蝕構造體",
  desc: "海風與鹽霧長期侵蝕未完成建築，外牆逐漸被海岸環境重塑，如同人工構造物向地質體轉化的中間階段。",
  lat: 30.8227055,
  lng: 121.5305626,
  archiveDate: "2024.08",
  type: "record"
...
{
  name: "磚艦墳場",
  desc: "巨大混凝土船體長期停滯於城市邊緣，彷彿未曾下水便提前退役的內陸艦隊。",
  lat: 30.5854444,
  lng: 104.0365278,
  archiveDate: "2024.10",
  type: "record"
...
{
  name: "鈣河嘴沉塔",
  desc: "废弃水泥工业遗构，混凝土粉尘长期沉积在山体边缘。生产线停止后，巨型窑体逐渐被植被与雨水侵蚀，形成缓慢崩解的工业地层。",
  lat: 30.4416944,
  lng: 104.0347500,
  archiveDate: "2025.09",
  type: "record"
