...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 确保 video-chapters 不受 video-ui 绝对定位的局部限制
    const attachmentStage = document.getElementById('attachment-stage');
    const videoChapters = document.querySelector('.video-chapters');

    if (attachmentStage && videoChapters && videoChapters.parentNode !== attachmentStage) {
        attachmentStage.appendChild(videoChapters);
    }
