...
const siteTagsMapping = {
    ...
    "崖隐蚀垣": "soil, mountain, slope, wall, eroded, cliff, chamber",
    ...
    function renderStack(siteArray, container, isGarden) {
        ...
        siteArray.forEach((site, index) => {
            ...
            docEl.addEventListener('click', (e) => {
                ...
                // Keep the original absolute-position + translate animation,
                // but calculate a stable, slightly lower viewport destination.
                // This prevents an ever-growing record stack from pulling the
                // extracted card higher and higher while preserving the old motion.
                ...
                if (!isExtracted) {
                    // Leave the variable in place during the return transition;
                    // it will be recalculated next time this card is extracted.
                }
            });
