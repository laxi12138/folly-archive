...
const i18n = {
  zh: {
    document_title:'遺構館 · 檔案系統', panel_title:'遺構館 · 檔案系統', form_title:'檔案投稿', mark_location:'標記地點', layers_title:'顯示層',
        layer_border: '國家邊界', layer_satellite: '衛星圖', layer_terrain: '地形等高線', layer_human: '人類居住痕跡', layer_archive: '已檔案的遺構', layer_visitors:'訪客投稿',
  ...
  ja: {
    ...
    layer_border:'国境', layer_satellite:'衛星画像', layer_terrain:'地形等高線', layer_human:'人間居住の痕跡', layer_archive:'収蔵済み遺構', layer_visitors:'来訪者投稿',
