...
'plague-scan': {
  ...
  'plague-film': {
    ...
    'north-ticket': {
        title: '物件標本',
        mode: 'image',
        src: 'attachments/fallen-wing-field/aviation-moduel.jpg',
        desc: ''
    },
...
'quarry-audio': {
  ...
  desc: ''
    ...
    'quarry-ticket': {
        title: '物件標本',
        mode: 'image',
        src: 'attachments/quarry-bay-stairway/pebble.jpg',
        desc: ''
    },
'quarry-note': {
  title: '註釋卡',
...
`;
    ...
    treeHTML = createRecordTree({
        ...
        folder: 'fallen-wing-field',

        visualFiles: `

      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-01')">
 ...
 <div
        class="tree-file"
        onclick="openAttachmentViewer('north-02')">
 ...
 <div
        class="tree-file"
        onclick="openAttachmentViewer('north-03')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-04')">
    ...
    `,
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-hum')">
    ...
    `,
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-ticket')">
    ...
    `,
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('north-note')">
...
<div
  ...
  treeHTML = createRecordTree({
    ...
    `,
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('quarry-ticket')">
...
<div
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('yellow-03')">
...
<div
     ...
     <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-04')">
...
<div
        class="tree-file"
        onclick="openAttachmentViewer('fish-05')">
      ...
      <div
        class="tree-file"
        onclick="openAttachmentViewer('fish-06')">
  ...
  treeHTML = createRecordTree({
    ...
    <div
       ...
       <div
        class="tree-file"
        onclick="openAttachmentViewer('gloss-04')">
