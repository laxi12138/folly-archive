...
{
    name: "荒隙庭",
    desc: "一處被圍牆完整圈起的方形遺構，只留下一道門寬的出口，如同巨大荒土孕育出的微型廢墟，又像一盆被遺忘的「廢墟盆栽」。牆頂嵌滿的玻璃碎片原是舊時防越的工法，而當牆體逐漸風化崩裂，這些碎片卻仍透明、鋒利，繼續守護著一片早已無人需要守護的空地。",
        lat: 31.2270054,
            lng: 121.6191375,
                archiveDate: "2018.07",
                    type: "record"
...
{
    name: "潮汐浴場",
        desc: "舊海水浴場遺蹟，海浪與混凝土結構長期共振侵蝕，形成半沉沒的地形劇場。",
            lat: 37.78060,
                lng: -122.51370,
                    archiveDate: "2023.08",
                        type: "record"
},
{
    ...
    {
        name: "遺構拓膜",
        desc: "一層半透明的工程塑料布緊貼著殘牆起伏，細緻地覆寫了每一道裂紋與每一片磁磚。它像一場拓印，留下建築消失前最後一次完整的形體。",
        lat: 30.7023424,
        lng: 104.0714623,
        archiveDate: "2024.04",
        type: "record"
    },
{
    ...
    {
        name: "苔網波塬",
        desc: "工業遺址被綠色苔狀紗網覆蓋，建築殘骸在雨季與垃圾沉積作用下形成起伏波浪地形，彷彿一層持續呼吸的地質薄膜。",
        lat: 30.66457,
        lng: 104.15798,
        archiveDate: "2024.05",
        type: "record"
    },
{
  ...
  type: "record"
    ...
    {
        name: "光原驛",
        desc: "四千五百畝光伏陣列覆蓋了原本的土地，只剩下一座近似汽車旅館的建築孤立其中。它像公路旅行留下的最後一站，等待一條早已不存在的道路。",
        lat: 38.83587,
        lng: 117.55678,
        archiveDate: "2024.08",
        type: "record"
    ...
    {
        name: "牧區投幣敖包",
            desc: "如果身處一片無法離開的荒原，只能得到一樣東西，大概會選擇地圖或電話。然而這裡留下的卻是成堆的遊戲機台。它們被堆疊成一座電子敖包，像一場錯誤抵達的願望，一種一無所有中得到無用之物的絕望。",
                lat: 41.72871,
                    lng: 110.51296,
                        archiveDate: "2024.12",
    ...
    },
    {
        ...
        {
            name: "屋脊梯田",
            desc: "整座山體被開採成階梯，散落其上的屋舍彷彿被收割過的作物，只留下失去屋頂的磚牆，在岩層間逐漸風化。",
        lat: 30.425167,
        lng: 104.096167,
        archiveDate: "2025.02",
        type: "record"
    ...
    {
        name: "遷港空址",
        desc: "沿江舊聚落因新區開發逐步拆遷，牆上的「拆」與「未簽字」成為最後仍留在此地的文字。居民陸續離開，生活痕跡卻仍停留於屋內，整片街區懸置於搬遷與廢墟之間，如同一座尚未完成撤離的港口。",
        lat: 30.4325100,
        lng: 104.0406300,
        archiveDate: "2026.06",
        type: "record"
    ...
    {
        name: "空礦階",
            desc: "礦層已被搬空，只剩沿山體層層展開的建築骨架。鐵軌、鋼索與提升井深入山腹，如同暴露於外的神經束。失去礦石後，它們仍指向更深的黑暗，只是再沒有任何訊號返回。",
                lat: 34.5275555,
                    lng: 119.1429722,
                        archiveDate: "2026.07",
                            type: "record"
