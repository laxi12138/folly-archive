...
window.showCompass = function () {
    ...
    if (mainFrame && compassContainer) {
        ...
        // 核心修改：在视窗中心的基础上，向右偏移 (例如 +60px)，向下偏移 (例如 +40px)
        // 你可以根据实际视觉效果自由调整这两个加减数值
